<?php
/**
 * Review control class.
 */
class ButterBean_Control_Review extends ButterBean_Control {
	...
	public function __construct( $manager, $name, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			...
			array(
				...
				'remove_review'  	 => esc_html__( 'Remove Block', 	 'butterbean' ),
				'add_review'     	 => esc_html__( 'Add Block',    	 'butterbean' )
			)
		);
	}
	...
	public function enqueue() {
		wp_enqueue_script( 'butterbean-review', get_template_directory_uri() . '/inc/butterbean-extras/extensions/js/butterbean-review.js', array( 'butterbean' ), 2, true );
		wp_enqueue_style( 'butterbean-review', get_template_directory_uri() . '/inc/butterbean-extras/extensions/css/butterbean-review.css', array(), 2 );
	}
	...
	public function to_json() {
		...
		if ( !empty($value_array) ) {
			foreach ( $value_array as $value ) {
				...
				$this->json['reviews'][] = $value;
			}
		} else {
			$this->json['reviews'] = array(
				array(
					'image' => '',
					'iconid' => '',
					'heading' => '',
...
function butterbean_sanitize_review( $data ) {
