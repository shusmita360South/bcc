<?php
/**
 * Timestamp control class.  This class is meant for storing a timestamp.
 *
 ...
 * @access public
 */
class ButterBean_Control_Timestamp extends ButterBean_Control {
	...
	public function to_json() {
		...
		$this->json['show_time'] = false;

		$field_name = $this->get_field_name();

		// Get project start/end dates.
		$date = (int) $this->get_value();
		// $date = 1500940800;
		...
		$hour   = $date ? date( 'H', $date ) : '';
		$minute = $date ? date( 'i', $date ) : '';
