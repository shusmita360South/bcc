<?php $submission = contact_submission('Prayer'); ?>
					...
					<?php if (empty($_POST)){?>
							...
							<div uk-grid class="">	
						        ...
						        <div class="uk-width-1-1">
						        	...
						        	<textarea placeholder ="Please detail what you would like prayer for" class="uk-textarea required" rows="5" name="message" id="message"></textarea>
						        </div>	
							</div>
