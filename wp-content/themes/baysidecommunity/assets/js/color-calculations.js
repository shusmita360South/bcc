 ...
 * @return {Object} - this
 */
function _baysideCommunityColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_baysideCommunityColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_baysideCommunityColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_baysideCommunityColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _baysideCommunityColor object.
 *
 * @since Bayside Community 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function baysideCommunityColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _baysideCommunityColor( backgroundColor, accentHue );
